package com.microservice.three.component.queue;
 ...
 */
@Configuration
public class ServiceThreeRabbitMQBean implements RabbitListenerConfigurer {
    
    public final static String queueName = "com.microservice.microservices-sample.service-three";
